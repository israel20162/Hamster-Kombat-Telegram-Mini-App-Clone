...
const Hand: React.FC<IconProps> = ({ size = 24, className = "" }) => {
  ...
  return (
    <div>
      <svg
        ...
        fill="#ffffff"
        className={`iconify iconify--noto ${className}`}
        height={svgSize}
        width={svgSize}
      >
        ...
        <g id="SVGRepo_iconCarrier">
          {"{"}" "{"}"}
          <radialGradient
            id="IconifyId17ecdb2904d178eab9033"
            cx="56.533"
            cy="33.205"
            r="92.59"
          ...
          >
            {"{"}" "{"}"}
            <stop stopColor="#FFCA28" offset=".353">
              {"{"}" "{"}"}
            </stop>
            {"{"}" "{"}"}
            <stop stopColor="#FFB300" offset=".872">
              {"{"}" "{"}"}
            </stop>
            {"{"}" "{"}"}
          </radialGradient>
          ...
          <defs>
            {"{"}" "{"}"}
            <path
              id="IconifyId17ecdb2904d178eab9034"
          ...
          {"{"}" "{"}"}
          <clipPath id="IconifyId17ecdb2904d178eab9035">
            {"{"}" "{"}"}
            <use xlinkHref="#IconifyId17ecdb2904d178eab9034"> </use>
            {"{"}" "{"}"}
          </clipPath>
          {"{"}" "{"}"}
          <g clipPath="url(#IconifyId17ecdb2904d178eab9035)">
            {"{"}" "{"}"}
            <path
              d="M90.13 69.44C76.2 71.43 67.51 84.02 63.57 97.49c-.54 1.86 1.29 2.44 1.83.58c3.68-12.55 14.35-21.64 27.26-23.48c1.9-.27 1.09-3.16-.8-2.89l-1.73-2.26z"
              fill="#EDA600"
            >
              {"{"}" "{"}"}
            </path>
